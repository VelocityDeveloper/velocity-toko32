    ...
    <div class="vsearch">
        <form method="get" id="searchform" action="<?php echo esc_url(home_url('/')); ?>">
            ...
            <div class="input-group">
                <input class="field form-control rounded-start" id="s" name="s" type="text" placeholder="Cari Produk" value="<?php the_search_query(); ?>" required>
                <span class="input-group-append bg-colortheme rounded-end">
                    <button type="submit" class="submit btn h-100 py-2 px-3 btn-sm">
